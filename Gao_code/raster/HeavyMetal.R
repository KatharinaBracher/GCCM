...
write.csv(results,file="GeochemResult/dTRI_nlights03.csv")     

par(mfrow=c(1,1))
par(mar=c(5, 4, 4, 2) + 0.1)

jpeg(filename = "GeochemResult/dTRI_nlights03.jpg",width = 600, height = 400)     #Plot the cross-mapping prediciton results
